...
import { deleteEmployee, listEmployees,viewEmployee} from '../services/employeeEservices'
        ...
        employees.map(employee => (
          <tr key={employee.id}> 
            ...
            <td> 
              ...
              >Delete</button>
               <button className="btn btn-outline-info"onClick={() => displayEmployee(employee.id)}
                           style={{ marginLeft: '5px' }}
                        >
                           View
                        </button>
